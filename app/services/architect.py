...
async def run_architect(
    ...
    *,
    ...
    try:
        ...
        if not on_token:
            raise
    return await _retry_as_json(client, messages, model=model, on_token=on_token, raw=raw)
...
async def _retry_as_json(
    ...
    *,
    ...
    result = await client.acomplete(retry_messages, model=model, json_mode=True)
